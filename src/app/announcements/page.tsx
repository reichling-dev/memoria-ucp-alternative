...
import { FileText, User, LogOut, Bell, Calendar, AlertTriangle, Star, Zap } from 'lucide-react'
      ...
      <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div className="container flex h-16 items-center justify-between px-4">
          ...
          <nav className="hidden md:flex items-center gap-6">
            ...
            <Link href="/announcements" className="text-sm font-medium text-foreground">
              Announcements
            </Link>
        ...
        <div className="space-y-8">
          {announcements.length === 0 ? (
            ...
            announcements.map((announcement) => {
              ...
              return (
                <Card key={announcement.id} className={`group border-0 bg-gradient-to-br ${typeInfo.color} hover:shadow-lg transition-all duration-300 hover:-translate-y-1`}>
                  <CardHeader className="pb-4">
                    <div className="flex items-start justify-between">
                      <div className="flex items-center space-x-4">
                        ...
                        <div>
                          <CardTitle className="text-2xl font-bold mb-2">{announcement.title}</CardTitle>
